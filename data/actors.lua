...
goblin = {
    ...
    interact_function = function(actor)
        -- Não precisamos chamar pathfinder.request_move aqui,
        -- pois isso já é feito na função move_to_actor
        console.print("Interagindo com o Goblin")
        -- Aqui você pode adicionar a lógica específica para interagir com o Goblin
        -- Por exemplo, atacar ou realizar alguma outra ação
    end
}
